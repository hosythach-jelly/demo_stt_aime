//  let socket = new WebSocket("ws://localhost:8001");103.252.2.161
// let socket = new WebSocket("wss://6a8a-103-252-2-161.ngrok-free.app");
let socket = new WebSocket("ws://103.252.2.161:8001");
let displayDiv = document.getElementById('textDisplay');
let server_available = false;
let mic_available = false;
let fullSentences = [];

const serverCheckInterval = 10000; // Check every 5 seconds

function connectToServer() {
    // socket = new WebSocket("ws://0.tcp.ap.ngrok.io:11896");

// socket = new WebSocket("ws://localhost:8001");
socket = new WebSocket("ws://103.252.2.161:8001");
// socket = new WebSocket("wss://6a8a-103-252-2-161.ngrok-free.app");
    // socket = new WebSocket("ws://localhost:8001");
